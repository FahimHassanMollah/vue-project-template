...
const isUpdateButtonDisabled = computed(() => {
    console.log(blogTitle.value, blogDescription.value, selectedBlogCategory?.value?.name);
...
const getBlogTagsHanlder = async () => {
...
<template>
    <AppLayout>
        <div>
            <template v-if="(blogCategoriesStatus?.isLoading) || (blogTagsStatus?.isLoading)">
                <Loader />
            </template>
            <div class="container mx-auto">
                <form class="w-full py-20">
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full md:w-2/3 px-3 mb-6 md:mb-0">
                            ...
                            <input
                                class="appearance-none block w-full  text-gray-700 border border-gray-200 rounded py-2 px-4 mb-3 leading-tight focus:outline-none"
                        ...
                        <div class="w-full md:w-1/3 px-3">
                            ...
                            <VueMultiselect id="blogCategories" v-model="selectedBlogCategory" :options="blogCategories"
                                :show-labels="false" :searchable="false" :allow-empty="false" label="name"
                    ...
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full md:w-2/3 px-3 mb-6 md:mb-0">
                            ...
                            <textarea v-model="blogDescription"
                                class="w-full text-gray-700 border border-gray-200 rounded py-2 px-4 mb-3 leading-tight focus:outline-none"
                        ...
                        <div class="w-full md:w-1/3 px-3">
                            <div class="mb-6">
                                ...
                                <VueMultiselect :show-labels="false" class="multiselect-blue" :multiple="true" id="blogTags"
                            ...
                            <div>
                                ...
                                <div
                                    ...
                                    <input type="checkbox" v-model="blogStatus" name="toggle" id="toggle"
                    ...
                    <div class="flex justify-end">
                        <button
                            ...
                            type="button" :disabled="isUpdateButtonDisabled">
                            Create Blog
                        </button>
                    </div>
